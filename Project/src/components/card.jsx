...
<div class="bg-light-coreco w-12 h-12 rounded-full uppercase
 ...
 VG</div>
    ...
    <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-light-coreco rounded-lg hover:bg-light-light-coreco focus:ring-4 focus:outline-none focus:ring-dark-coreco dark:bg-dark-coreco dark:hover:bg-dark-coreco dark:focus:ring-dark-coreco">
        Read more
